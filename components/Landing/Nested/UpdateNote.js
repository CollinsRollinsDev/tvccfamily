...
const UpdateNote = ({
  ...
  const { userDetails, updateTabSwitch, currentPostId } = useSelector(
  ...
  const handleSave = async () => {
    ...
    if (!addTitle && !addPost && !addMinistering) {
      Alert.alert(
        `ERROR!!!`,
        `Seem like some fields are missing. Please fix and try again.`,
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <TextInput
          ...
          onChangeText={(e) => setAddTitle(e)}
          style={styles.inputArea}
          placeholder="Title Here...."
        />
        <TextInput
          defaultValue={currentMinistering}
          onChangeText={(e) => setAddMinistering(e)}
          style={styles.inputArea}
          placeholder="Ministering Here...."
        />
