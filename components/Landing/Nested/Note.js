...
const Note = ({ navigation }) => {
  ...
  const handleEdit = async () => {
    updateTabSwitch
      ...
      : dispatch(setUpdateTebSwitch(true));
  };
    ...
    <View style={styles.body}>
      ...
      <View style={styles.notePreviewContainer}>
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          ...
          <Text style={styles.minister}>{`By: ${currentMinistering}`}</Text>
          <Text style={styles.postBody}>{currentPostBody}</Text>
        </ScrollView>
      </View>
      ...
      <View style={styles.body}>
        {!updateTabSwitch ? (
          ...
          <UpdateNote
            ...
            currentMinistering={currentMinistering}
